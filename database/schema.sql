...
CREATE TABLE VIOLATION(
	...
	CONSTRAINT licence_no_fk FOREIGN KEY(license_no) REFERENCES DRIVER(license_no) ON DELETE CASCADE,
	CONSTRAINT plate_no_fk FOREIGN KEY(plate_no) REFERENCES VEHICLE(plate_no) ON DELETE CASCADE
);
